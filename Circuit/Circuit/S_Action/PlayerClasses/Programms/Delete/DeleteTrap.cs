...
namespace Circuit.S_Action.PlayerClasses.Programms.Delete
{
    class DeleteTrap : Trap
    {
        ...
        public DeleteTrap(string _path, Game _GAME, Vector3 _pos, Quaternion _ori, PlayerIndex _index)
            : base(DeleteFactory.GetPhysicalEntity(Data.DEL_TRAPENTITYSCALE),
            ...
            )
        {
            ...
            this.Entity.CollisionInformation.Tag = new CollisionTag(Data.RunType.TRAP, Data.ProgrammType.DELETE, this.EntityScaling, _index);
